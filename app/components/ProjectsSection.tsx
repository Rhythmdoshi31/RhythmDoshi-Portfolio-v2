...
export default function ProjectsSection() {
  const arr1: Project[] = [
    ...
    },
    {
      slug: "societysync",
      heading: "SocietySync",
      subheading: "Society Management Platform",
      image: "/projects/p22.webp",
      alt: "Society management platform with role based access and ticketing",
    },
  ];
  ...
  const arr2: Project[] = [
    {
      slug: "livelychat",
      heading: "LivelyChat",
      subheading: "Online Chat Application",
      image: "/projects/p3.webp",
      alt: "Real time chat and video calling app using WebRTC",
    },
    {
      slug: "cineclair",
      heading: "CineClair",
      subheading: "Movie & TV Recommendation Hub",
      image: "/projects/p4.webp",
      alt: "Movie discovery app with search and trending recommendations",
    },
  ];
  ...
  const arr3: Project[] = [
    {
      slug: "portfolio",
      heading: "Portfolio",
      subheading: "My Personal Website v2",
      image: "/projects/p5.webp",
      alt: "Developer portfolio website showcasing projects and responsive UI design",
    },
    {
      slug: "leetcode-hider",
      ...
      alt: "Chrome extension hiding LeetCode difficulty for focused coding practice",
    },
  ];
      ...
      <div className="w-full border-b">
        <div className="innerContainer h-5 flex items-center justify-end px-4 py-3">
          <h5 className="text-sm text1 font2 tracking-tighter underline flex items-center gap-1 hover:!text-zinc-700 transition ease-in">
            <Link href={"https://github.com/Rhythmdoshi31?tab=repositories"}>
