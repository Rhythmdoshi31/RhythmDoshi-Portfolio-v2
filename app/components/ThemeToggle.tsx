...
import type { Point, Stick, MouseState, RGB } from "../types/Themetoggle.types";
...
const ThemeToggle = () => {
  ...
  useEffect(() => {
    ...
    const onPointerDown = (e: PointerEvent | MouseEvent | TouchEvent) => {
      ...
      const endPoint = points.current.at(-1)!; //Last
      const bodyW = 24;
      const bodyH = 36;
  ...
  return (
    <div className="fixed top-0 right-[12.5vw] sm:right-[6vw] z-[999] pointer-events-none w-[160px] h-[260px]">
      <canvas
        ref={canvasRef}
